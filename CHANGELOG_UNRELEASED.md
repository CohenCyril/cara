...
- in `ereal.v`:
  + definitions `dual_adde` and `dual_mule`
  ...
  + lemmas `dual_addeE`, `dual_sumeE`, `def_dual_addeE`, `daddEFin`,
    ...
    `daddeAC`, `daddeCA`, `daddeACA`, `doppeD`, `dmuleC`, `dmule1`,
    `dmul1e`, `daddeK`, `dsubeK`, `dsubee`, `dadde_eq_pinfty`,
    `daddooe`, `dadde_Neq_pinfty`, `dadde_Neq_ninfty`,
    `desum_fset_pinfty`, `desum_pinfty`, `desum_fset_ninfty`,
    `desum_ninfty`, `dadde_ge0`, `dadde_le0`, `dsume_ge0`,
    `dsume_le0`, `dmule_ge0`, `dual_muleE`, `dsube_lt0`, `dsubre_le0`,
